...
INSERT INTO `produtoB` VALUES (1,'Geely',10500),(2,'McLaren',222000),(3,'Rely',30500),(4,'Tata',40900),(5,'Buggy',50500),(6,'Kart',35700),(7,'Cadillac',45800),(8,'Saab',60500),(9,'Mazda',150000),(10,'Menon',50050);
...
CREATE TABLE `vendaB` (
  ...
  CONSTRAINT `fk_cliente_vendaB` FOREIGN KEY (`id_cliente`) REFERENCES `clienteB` (`id_cliente`) ON UPDATE CASCADE,
  CONSTRAINT `fk_produto_vendaB` FOREIGN KEY (`id_produto`) REFERENCES `produtoB` (`id_produto`) ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=12 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-02-18 11:25:27
