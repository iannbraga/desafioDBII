...
INSERT INTO `clienteA` VALUES (11,'Luís Victor','38950484536','1987-05-21'),(12,'Matheus Rafael','44689680019','1993-09-02'),(13,'Pedro Henrique','94294328932','1990-08-03'),(14,'Gabrielly Mariane','48332090636','2000-07-04'),(15,'Jaqueline Araújo','11229400842','1985-06-05'),(16,'Rosângela Melissa','48842634050','1975-05-06'),(17,'Caio Campos','41686243235','1996-04-07'),(18,'Janaina Silva','88200049507','2001-03-08'),(19,'Jurema Pereira','66025317780','1991-02-09'),(20,'Jubisclelson Pinto','90838449786','2000-01-10');
...
INSERT INTO `produtoA` VALUES (11,'Uno Mille',11000),(12,'Fiat Palio',22000),(13,'Celta',33000),(14,'Fiesta',54000),(15,'Honda Civic',50000),(16,'Strada',35000),(17,'Van',45000),(18,'Caminhao',65000),(19,'Ambulancia',15000),(20,'Viatura',25000);
...
CREATE TABLE `vendaA` (
  ...
  CONSTRAINT `fk_cliente_vendaA` FOREIGN KEY (`id_cliente`) REFERENCES `clienteA` (`id_cliente`) ON UPDATE CASCADE,
  CONSTRAINT `fk_produto_vendaA` FOREIGN KEY (`id_produto`) REFERENCES `produtoA` (`id_produto`) ON UPDATE CASCADE
...
INSERT INTO `vendaA` VALUES (2,'02-02-2000',12,3,11,11),(2,'02-02-2000',10,6,12,18),(4,'03-02-2000',11,4,13,12),(5,'04-02-2000',9,5,14,13),(7,'05-02-2000',7,7,15,14),(2,'06-02-2000',8,5,16,15),(5,'07-02-2000',5,2,17,16),(4,'08-02-2000',4,1,18,17),(6,'09-02-2000',6,2,19,19),(2,'10-02-2000',3,0,20,20);
...
INSERT INTO `vendaB` VALUES (1,1,1,10000,'02-10-2018','250'),(2,1,2,21000,'02-10-2018','250'),(3,1,3,21000,'02-10-2018','250'),(4,2,4,541000,'02-10-2018','250'),(5,2,5,121000,'02-10-2018','250'),(6,2,6,10000,'02-10-2018','250'),(7,3,7,15000,'02-10-2018','250'),(8,3,5,10600,'02-10-2018','250'),(9,8,9,10800,'02-10-2018','250'),(10,9,10,10020,'02-10-2018','250'),(11,11,11,11000,'02-02-2000','16500'),(12,12,18,22000,'02-02-2000','17600'),(13,13,12,33000,'03-02-2000','84000'),(14,14,13,54000,'04-02-2000','120000'),(15,15,14,50000,'05-02-2000','0'),(16,16,15,35000,'06-02-2000','26250'),(17,17,16,45000,'07-02-2000','135000'),(18,18,17,65000,'08-02-2000','195000'),(19,19,19,15000,'09-02-2000','60000'),(20,20,20,25000,'10-02-2000','50000');
...
-- Dump completed on 2020-02-18 12:02:51
